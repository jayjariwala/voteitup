  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a href="dashboard" class="navbar-brand "><i class="fa fa-check-square-o nav-color"></i> <b><span class="logo-fonts nav-color"> Voteitup!</span></b></a>
        ...
        <span class="visible-sm visible-xs" > <a class="navbar-brand " style="font-family: 'Noto Serif', serif; color: white "><i class="fa fa-user"></i><span class="nav-color"> <%=bean.getName() %></span></a></span>
...
<center><a href="dashboard"><button class="btn-primary btn" style="font-family: 'Noto Serif', serif;">New Poll</button> </a><a href="mypolls"><button class="btn btn-default" style="font-family: 'Noto Serif', serif;">My Polls</button></a></center>
...
<% if(status != null)
{
	if(status.equals("1"))
	{
		out.print("<div class='alert alert-success' role='alert'><center><a href='#' class='alert-link'> Poll Added Successfully!</a></center></div>");	
	}
	else
	{
		out.print("<div class='alert alert-danger' role='alert'><center><a href='#' class='alert-link'>Opps something went wrong!</a></center></div>");
	}
}
...
<div class="container-fluid">
<center><h3 style="font-family: 'Noto Serif', serif;">New Poll</h3></center>


<form class="form-horizontal" id="form" data-toggle="validator" method="post" action="createpoll">


<!-- Form Name -->
<legend></legend>
<center><i><h5 style="font-family: 'Noto Serif', serif;">Name Your Poll</h5></i></center>
<!-- Password input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="passwordinput" style="font-family: 'Noto Serif', serif;"></label>
  <div class="col-md-4 col-xs-12">
    <input  type="polltitle" placeholder="Poll Title"  name="polltitle" class="form-control input-md" required>
...
<div class="col-lg-4">
      ...
      <div class="form-group">
  <label for="comment"><i>Options(Sperated by New Line)</i></label>
  <textarea class="form-control input-md" name="options" rows="5" required> </textarea><div class="help-block with-errors"></div>
...
<div class="col-lg-4">
<center><button class="btn btn-group btn-success btn-block" style="font-family: 'Noto Serif', serif;" >Submit</button></center><br/>
</div>
<div class="col-lg-4">
</div>
